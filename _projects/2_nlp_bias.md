...
> **Accepted to the [EMNLP 2026](https://2026.emnlp.org/) Main Conference** (Budapest, Hungary). 15.4% Main Conference acceptance rate out of 17,669 submissions.

- First systematic characterization of _language-of-study (LoS) bias_ — when reviewers evaluate a paper based on the language(s) it studies rather than its scientific merit.
...
- Identified four subcategories of negative bias; _demanding unjustified cross-lingual generalization_ dominates (~62% of negative-bias cases).
